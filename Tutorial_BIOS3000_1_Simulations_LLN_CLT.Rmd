...
<div class = "green"> If you are new to loops, you may want to pause here and make a simpler loop to make sure you understand how it works (you can for example compute `i^2` (`i` to the power of 2) and `2^i` (2 to the power of `i`) in a loop where you let `i` go from 0 to 10; you should get the same result as running `(0:10)^2` and `2^(0:10)`). You may also watch this [YouTube video from the Google Developers][loops].</div>

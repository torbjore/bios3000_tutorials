...
2. For each of the above models, identify the response variable, the predictor variable, the parameters, and the random and fixed parts (= "non-random" or "systematic") of the model.

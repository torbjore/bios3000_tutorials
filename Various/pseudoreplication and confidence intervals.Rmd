...
Through simulations we will here investigate how pseudoreplication biases confidence intervals (makes them too narrow such that 95% confidence intervals of parameters covers the true value less than 95% of the time). In particular, we will look at how the seriousness of pseudorepliaction depends on number of groups and the among group variance.
...
# Function that just returns TRUE if the 'truth' is contained in an interval 'int', # and FALSE otherwise

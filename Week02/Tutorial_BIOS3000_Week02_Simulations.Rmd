...
We assume that you are familiar with histograms and probability distributions. You may want to refresh these concepts from earlier course work or look at the [resources we refer to on Canvas](https://uio.instructure.com/courses/42893/pages/review-of-statistical-concepts-and-use-of-r?module_item_id=709386).
...
Make sure your name is included in the beginning of the document. Include a short introduction and write in words what you are doing and how you interpret the results. **Do not include any text that you have not written yourself unless the text is included as a quotation and the source is given.**

Submit a pdf-file, together with the Rmd-file on Canvas. The best way of creating a pdf-file is to knit directly to a pdf-file from the R Markdown document in RStudio. This requires that you have installed LaTeX (see instructions in the Week 1 module on Canvas). Alternatively, if you for some reason have problems knitting to a pdf-file, you can knit to a html-file and save (or print) this file to a pdf-file from your browser. We need the pdf-file to write comments in your text, so it is essential that you submit the pdf-file.
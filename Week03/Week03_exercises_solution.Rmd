...
Some points to notice:
  ...
  - That the estimates in Model E are exactly the same as the estimates in model C the for all parameters but the intercept. The is because these two models are just different parameterizations of the same model. The meaning of the intercept is different in the two models (see how in the text under point 3).</div>

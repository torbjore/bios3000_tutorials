...
A. `fit_Foot = lm(Height ~ Foot, data = student_means)`
  ...
  - Parameters:
    ...
    - $\beta_1 =$ Slope of the regression line; How many cm the expected height of people increase when foot length is increased with one cm.
...
**Note:** It is essential to understand why the parameters in these models have the meanings specified above - it follows from the mathematical description of the model. If this is not clear, it may help to make a sketch of the models on a piece of paper and mark off distances corresponding to the parameters. See also the prediction plots made below. 

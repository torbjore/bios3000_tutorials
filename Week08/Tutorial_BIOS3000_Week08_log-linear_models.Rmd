---
title: Tutorial Week 9 - Log-linear log-normal models
...
We can do the same for the 95% confidence limits of the parameter to get a confidence interval for the expected relative change in BMR when body mass is doubled:
...
To use all the data we have available, you should combine the "vitruvian" data (BIO2150 students) you used during the R course of Week 1 with the mean measurements of BIOS3000/4000 students. Start by reading in these data and look at their summary:
